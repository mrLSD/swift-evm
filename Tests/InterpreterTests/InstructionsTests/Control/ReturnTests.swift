    ...
    override class func spec() {
        describe("Instruction RETURN") {
            ...
            it("check stack underflow errors is as expected") {
                var m1 = TestMachine.machine(opcode: Opcode.RETURN, gasLimit: 10)
                m1.evalLoop()
                ...
                var m2 = TestMachine.machine(opcode: Opcode.RETURN, gasLimit: 10)
            ...
            it("Success") {
                var m = TestMachine.machine(opcode: Opcode.RETURN, gasLimit: 100)
