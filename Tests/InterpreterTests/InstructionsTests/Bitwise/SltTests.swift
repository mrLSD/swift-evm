...
final class InstructionSltSpec: QuickSpec {
    @MainActor
    static let machine = TestMachine.machine(opcode: Opcode.SLT, gasLimit: 10)
    @MainActor
    static let machineLowGas = TestMachine.machine(opcode: Opcode.SLT, gasLimit: 2)

    override class func spec() {
        describe("Instruction SLT") {
            it("a < b") {
                var m = Self.machine
