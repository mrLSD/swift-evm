...
public struct H160: FixedArray, Hashable {
    ...
    /// Equality on stored fields — no `BYTES` array allocation. Hot for `[H160: …]` dictionary lookups
    /// (e.g. `MemoryState.accounts`, `storages`).
    @inlinable @inline(__always)
    public static func == (lhs: H160, rhs: H160) -> Bool {
        lhs.l0 == rhs.l0 && lhs.l1 == rhs.l1 && lhs.l2 == rhs.l2
    }
